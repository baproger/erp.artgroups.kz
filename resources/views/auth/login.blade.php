...
<div class="hidden lg:flex lg:w-[55%] bg-mesh relative overflow-hidden flex-col justify-between p-12">
    ...
    <div class="relative fade-left delay-5">
        <div class="flex items-center gap-2 text-emerald-300/60 text-xs">
            ...
            <span>Разработано <a href="https://instagram.com/baproger.kz" target="_blank" class="text-emerald-400 hover:text-emerald-300 transition-colors font-medium">baProger.kz</a></span>
        </div>
    </div>
</div>
...
<div class="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 bg-white">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="lg:hidden mt-10 text-center fade-up">
            <a href="https://instagram.com/baproger.kz" target="_blank" class="inline-flex items-center gap-1.5 text-xs text-gray-400 hover:text-pink-500 transition-colors">
